...
public class CharacterManager : MonoBehaviour
{
    ...
    [SerializeField] private float _runRadius = 7f;
    [SerializeField] private float _landingRadius = 12f;
    [SerializeField] private float _bloodRadiusScale = 6f;
    ...
    void Update()
    {
        ...
        if (_fpsController)
        {
            float newRadius = Mathf.Max(_walkRadius, (100f - _health) / _bloodRadiusScale);
